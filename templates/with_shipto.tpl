...
<div id="container">
	...
	<table width="100%" align="center">
		...
		{ if $invoice.custom_field1 != null}
	        <tr>
        	        <td class="tbl1-bottom col1" border=1 cellpadding=2 cellspacing=1><b>{$customFieldLabels.invoice_cf1|htmlsafe}:</b></td>
                                <td class="col1 tbl1-bottom" border=1 cellpadding=2 cellspacing=1 colspan="3">{$invoice.custom_field1|htmlsafe}</td>
        	</tr>
                {/if}
	...
	<tr>
			<td class="tbl1-bottom col1" ><b>{$LANG.customer_bill_to}:</b></td>
...
*}
	...
	<tr>
		<td colspan="6"><div style="font-size:12pt;" align="center">{$biller.footer|outhtml}</div></td>
	</tr>
	<tr>
		<td>
			{online_payment_link 
